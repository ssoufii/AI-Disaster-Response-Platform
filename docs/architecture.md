...
- **No `<Gather>` here.** Per the IVR decision below, the keypress and its callback are #17's; #16 ships placement, playback and call-status handling. Until #17 merges, a call says "press 1" and nothing is listening — accepted only because #17 follows immediately in the same epic.
